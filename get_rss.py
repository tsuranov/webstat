...
async def get_rss(rss):
    ...
    try:
        ...
        print (rss[1] + ": connect pg ok")
        #Дата последней новости
        #
        last_published = (await conn.fetchrow('SELECT MAX( published ) FROM ' + rss[1] + ' ;'))[0]
        print (rss[1] + ": fetch last_p ok")
        #
        ...
        print(rss[1] + ": CONNECTION ERROR")
    except asyncpg.PostgresError as error: 
        print(rss[1] + ": other error")
    except OSError:
        print(rss[1] + ": OSError")
